...
graph TB
    ...
    classDef layer6 fill:#E3F2FD,stroke:#1976D2
    ...
    classDef layer2 fill:#FFEBEE,stroke:#D32F2F
    classDef layer1 fill:#F5F5F5,stroke:#616161
```

### 3.5 Technology Stack Architecture (Mermaid)
...
### 3.6 Deployment Architecture with Security Zones
...
### 3.8 Component Interaction Matrix

| Component | ServiceNow | Redis | OpenAI | Teams | SSM | ARS | Opera |
|-----------|------------|-------|--------|-------|-----|-----|-------|
| **GUARDIAN** | Read | Read/Write | — | — | — | — | — |
| **SCOUT** | Read | Read | — | — | — | — | — |
| **SHERLOCK** | Read | — | Chat API | — | — | — | — |
| **ROUTER** | Read | Read | — | — | — | — | — |
| **ARBITER** | Read | Read/Write | — | — | — | — | — |
| **HERALD** | Write | — | — | Webhook | — | — | — |
| **SCRIBE** | Write | Write | — | — | — | — | — |
| **JANITOR** | Read/Write | — | — | Approval | Run | Selenium | OHIP/Selenium |
